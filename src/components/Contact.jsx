        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-4 md:mt-8 gap-6">
          <div className="flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
              <FaLocationDot className="bg-[#f3484b25] p-6 w-28 h-28 rounded-full text-[#46f3a8] " />
              <p>Bole SubCity, Addis Ababa, Ethiopia</p>
            </div>
          </div>
          <div className="flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
              <AiTwotoneMail className="bg-[#f3484b25] p-6 w-28 h-28 rounded-full text-[#57d5f8] " />
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
              <AiFillPhone className="bg-[#f3484b25] p-6 w-28 h-28 rounded-full text-[#3d90d9] " />
              <p>+251911909090</p>
            </div>
          </div>
        </div>
