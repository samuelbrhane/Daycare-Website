    ...
    <div className="absolute top-0 left-0 bottom-0 w-full flex items-center">
      <div className="heroText w-full">
        <motion.div
          ...
          className="relative font-bold font-[Lora] italic text-lg md:text-2xl lg:text-[24px] text-[#3875d0]  xl:text-[30px] 2xl:text-[50px] flex flex-col  mb-2 md:mb-3 xl:mb-5"
        >
          <h1>
            A curriculum based{" "}
            <span className="text-white">on Inquiry &</span>
          </h1>
        </motion.div>
        ...
        >
          <div className="text-center bg-[#43330a81] py-2 md:py-4 lg:py-8 px-5 rounded flex flex-col">
            ...
            <div className="text-[8px] md:text-lg xl:text-2xl 2xl:text-3xl lg:mt-6 text-white italic">
              <p>
                Our child specialized in the development of your children with a
                focus on skill building through fun and interactive learning.
              </p>
            </div>
          </div>
        </motion.div>
